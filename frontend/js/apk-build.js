...
async function createBuild() {
  ...
  try {
    ...
    const message = $('apkBuildMessage');
    if (message) message.textContent = 'Build started. You can keep working in this page.';
  } catch (error) {
    console.error(error);
