...
export function mountWebsiteMode({project,definition,switchPage,root=document}={}){
  ...
  const target=root.querySelector('#published-components')||root.querySelector('#canvas')||root.querySelector('.published-shell')||root.body?.firstElementChild||root.firstElementChild;
